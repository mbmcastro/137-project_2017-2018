...
public class GameMenu extends JPanel implements ActionListener {
  ...
  private static JButton goalButton;
  private static JButton mechanicsButton;
  private static JButton controlsButton;
  private static JButton characterSButton;
  private static JButton characterNButton;
  ...
  private static JPanel userManualPanel;
  ...
  public GameMenu() {
    ...
    setVisible(true);
    setPreferredSize(new Dimension(GameMenu.FRAME_WIDTH, GameMenu.FRAME_HEIGHT));

    gameWindow = new JFrame("Ninja vs Samurai");
    gameWindow.setPreferredSize(new Dimension(GameMenu.FRAME_WIDTH, GameMenu.FRAME_HEIGHT));
    ...
    mechanicsButton = new JButton("Mechanics");
    controlsButton = new JButton("Controls");
    characterNButton = new JButton("Ninja");
    characterSButton = new JButton("Samurai");
    gameName = new JLabel("Ninja vs Samurai");
    ...
    background = new JLabel(new ImageIcon("../Assets/Images/UserManual/UserManual.png"));
    background.setPreferredSize(new Dimension(775, 525));
    ...
    mechanicsButton.addActionListener(this);
    controlsButton.addActionListener(this);
    characterNButton.addActionListener(this);
    characterSButton.addActionListener(this);


    //add components to panel
    lobbyPanel.add(playerName);
    lobbyPanel.add(ip);
    lobbyPanel.add(port);
    lobbyPanel.add(createLobby);
    lobbyPanel.add(joinLobby);
    lobbyPanel.add(help);
    lobbyPanel.add(gameName);
    lobbyPanel.add(playerNameLabel);
    lobbyPanel.add(ipLabel);
    lobbyPanel.add(portLabel);
    lobbyPanel.add(classSelectorContainer);

    userManualPanel.add(background);
    userManualPanel.add(goalButton);
    userManualPanel.add(mechanicsButton);
    userManualPanel.add(controlsButton);
    userManualPanel.add(characterNButton);
    userManualPanel.add(characterSButton);

    //add the JPanel into the JFrame
    super.add(lobbyPanel, "Lobby");
    super.add(userManualPanel, "UserManual");
  ...
  public void actionPerformed(ActionEvent e) {
    if(e.getActionCommand() == "Help"){
        ...
        cl.show(this, "UserManual");
    }
    if(e.getActionCommand() == "Goal"){
        background.setIcon(new ImageIcon("../Assets/Images/UserManual/NVS_Overview.png"));
    }
